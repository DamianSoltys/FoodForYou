      ...
      return $array;
          ...
          public function Signup($Signup_data,$crud){
            if(isset($Signup_data)){
                ...
                $query="INSERT INTO users(username,surname,email,pass,sex) 
                VALUES('$Signup_data->username','$Signup_data->surname','$Signup_data->email',
                '$Signup_data->pass','$Signup_data->sex')";
            ...
            public function Update($Change_data,$crud){
                if(isset($Change_data)){
                    ...
                    $Change_data->pass=$crud->escape_string($Change_data->pass);
                        ...
                        $query="UPDATE users SET username='$Change_data->username',surname='$Change_data->surname',
                        pass='$Change_data->pass',sex='$Change_data->sex' WHERE email='$user'";
                        $data=$crud->execute($query);
                        if($data){
